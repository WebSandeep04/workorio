...
// --- AI Task Scheduler Logic (Handled per-tenant inside the command) ---
Schedule::command('ai:fetch-tasks')
    ->everyMinute()
    ->timezone('Asia/Kolkata')
    ->description('Process AI Tasks across all tenants based on their individual schedules');
// --------------------------------
