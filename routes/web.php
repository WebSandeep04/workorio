...
use App\Http\Controllers\Msg91TemplateController;
...
Route::middleware(['auth.or.session'])->group(function () {
    ...
    Route::post('/signal-task/process-ai-start', [SignalTaskController::class, 'processAiStart'])->name('signal-task.process-ai-start');
    Route::post('/signal-task/process-ai-chat', [SignalTaskController::class, 'processAiChat'])->name('signal-task.process-ai-chat');
    ...
    Route::prefix('payroll')->name('payroll.')->group(function () {
        ...
        Route::post('attendance-review/lock-all', [App\Http\Controllers\Payroll\MonthlyAttendanceReviewController::class, 'lockAll'])->name('attendance.lockAll');
    ...
    Route::post('whatsapp-templates/test', [Msg91TemplateController::class, 'sendTestMessage'])->name('whatsapp-templates.test');
