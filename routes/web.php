...
Route::middleware(['auth.or.session'])->group(function () {
    ...
    Route::get('/reports/worklog/fetch', [WorklogReportController::class, 'fetchWorklogs']);
...
// Task Helper Routes
Route::middleware(['auth.or.session'])->group(function () {
    Route::get('/task/users', [TaskController::class, 'users'])->name('task.users');
    Route::get('/task/statuses', [TaskController::class, 'statuses'])->name('task.statuses');
    Route::get('/task/priorities', [TaskController::class, 'priorities'])->name('task.priorities');
    
    // Task CRUD & Actions
    Route::get('/task/project/{projectId}', [TaskController::class, 'fetchByProject'])->name('task.fetchByProject');
    Route::post('/task', [TaskController::class, 'store'])->name('task.store');
    Route::delete('/task/{id}', [TaskController::class, 'destroy'])->name('task.destroy');
    Route::put('/task/{id}', [TaskController::class, 'update'])->name('task.update');
    Route::post('/task/{id}/update', [TaskController::class, 'update']); // Fallback for POST without spoofing if needed
    
    Route::post('/task/{id}/toggle-done', [TaskController::class, 'toggleDone'])->name('task.toggleDone');
    Route::post('/task/{id}/poke', [TaskController::class, 'poke'])->name('task.poke');
    Route::delete('/task/{id}/image/{imageId}', [TaskController::class, 'deleteImage'])->name('task.deleteImage');
    Route::get('/task/{id}/image/{imageId}', [TaskController::class, 'serveImage'])->name('task.serveImage');
});
