        ...
        [
            ...
            'permission' => 'email_marketing.view',
                ...
                [
                    ...
                    'items' => [
                        // Core Setup
                        ['route' => 'state', 'title' => 'State', 'icon' => 'bi bi-globe', 'permission' => 'core.setup', 'feature_flag' => 'is_core_setup_enabled'],
                        ['route' => 'city', 'title' => 'City', 'icon' => 'bi bi-geo-alt', 'permission' => 'core.setup', 'feature_flag' => 'is_core_setup_enabled'],
                        ['route' => 'countries.index', 'title' => 'Countries', 'icon' => 'bi bi-flag', 'permission' => 'core.setup', 'feature_flag' => 'is_core_setup_enabled'],

                        // User Management
                        ['route' => 'user', 'title' => 'User Management', 'icon' => 'bi bi-people', 'permission' => 'user.view', 'feature_flag' => 'is_user_setup_enabled'],
                        ['route' => 'role-master', 'title' => 'Role Master', 'icon' => 'bi bi-shield-lock', 'permission' => 'role.manage', 'feature_flag' => 'is_user_setup_enabled'],

                        // Master Setup 
                        ['route' => 'branches.index', 'title' => 'Branches', 'icon' => 'bi bi-diagram-3', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],
                        ['route' => 'shifts.index', 'title' => 'Shift', 'icon' => 'bi bi-clock-history', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],
                        ['route' => 'departments.index', 'title' => 'Departments', 'icon' => 'bi bi-diagram-2', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],
                        ['route' => 'designations.index', 'title' => 'Designations', 'icon' => 'bi bi-badge-ad', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],
                        ['route' => 'employment-types.index', 'title' => 'Employment Types', 'icon' => 'bi bi-briefcase', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],
                        ['route' => 'leave-type.index', 'title' => 'Leave Types', 'icon' => 'bi bi-airplane', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],
                        ['route' => 'late-reasons.index', 'title' => 'Late Reasons', 'icon' => 'bi bi-clock-history', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],
                        ['route' => 'places.index', 'title' => 'Places', 'icon' => 'bi bi-map', 'permission' => 'master.setup', 'feature_flag' => 'is_master_setup_enabled'],

                        // Sales Setup 
                        ['route' => 'status', 'title' => 'Sales Status', 'icon' => 'bi bi-check2-circle', 'permission' => 'sales.setup', 'feature_flag' => 'is_sales_setup_enabled'],
                        ['route' => 'source', 'title' => 'Lead Source', 'icon' => 'bi bi-diagram-3', 'permission' => 'sales.setup', 'feature_flag' => 'is_sales_setup_enabled'],
                        ['route' => 'product', 'title' => 'Product', 'icon' => 'bi bi-box2', 'permission' => 'sales.setup', 'feature_flag' => 'is_sales_setup_enabled'],
                        ...
                        // Work & Project Setup 
                        ['route' => 'customer', 'title' => 'Customer', 'icon' => 'bi bi-person-badge', 'permission' => 'worklog.setup', 'feature_flag' => 'is_work_setup_enabled'],
                        ['route' => 'service', 'title' => 'Project Services', 'icon' => 'bi bi-kanban', 'permission' => 'projects.setup', 'feature_flag' => 'is_projects_setup_enabled'],
                        ['route' => 'module', 'title' => 'Module', 'icon' => 'bi bi-puzzle', 'permission' => 'projects.setup', 'feature_flag' => 'is_projects_setup_enabled'],
                        ['route' => 'customer-project', 'title' => 'Open Project', 'icon' => 'bi bi-collection', 'permission' => 'projects.setup', 'feature_flag' => 'is_projects_setup_enabled'],
                        ['route' => 'entry-type.index', 'title' => 'Entry Types', 'icon' => 'bi bi-list-check', 'permission' => 'worklog.setup', 'feature_flag' => 'is_work_setup_enabled'],
                        ['route' => 'holiday', 'title' => 'Holidays', 'icon' => 'bi bi-calendar2-event', 'permission' => 'attendance.setup', 'feature_flag' => 'is_attendance_setup_enabled'],

                        // Task & Subscription Setup 
                        ['route' => 'task-status.index', 'title' => 'Task Status', 'icon' => 'bi bi-tag', 'permission' => 'task.setup', 'feature_flag' => 'is_task_setup_enabled'],
                        ['route' => 'subscription-status.index', 'title' => 'Subscription Status', 'icon' => 'bi bi-tag', 'permission' => 'subscription.setup', 'feature_flag' => 'is_subscription_setup_enabled'],
                        
                        // Calendar Setup
                        ['route' => 'calendar-events.index', 'title' => 'Calendar Events', 'icon' => 'bi bi-calendar-plus', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.events'],
                        ['route' => 'calendar-missed-reasons.index', 'title' => 'Missed Reason', 'icon' => 'bi bi-calendar-x', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.events'],
                        ['route' => 'calendar-status.index', 'title' => 'Calendar Status', 'icon' => 'bi bi-tag', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.status'],
                        ['route' => 'calendar-status-checklist.index', 'title' => 'Status-Checklist', 'icon' => 'bi bi-link-45deg', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.status_checklist'],
                        ['route' => 'common-events.index', 'title' => 'Common Events', 'icon' => 'bi bi-collection', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.common_events'],
                        ['route' => 'calendar-social.index', 'title' => 'Calendar Social Handles', 'icon' => 'bi bi-share', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.social_handles'],
                        ['route' => 'calendar-clients.index', 'title' => 'Calendar Clients', 'icon' => 'bi bi-people', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.clients'],
                        ['route' => 'calendar-client-social.index', 'title' => 'Client Social Handles', 'icon' => 'bi bi-link-45deg', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.client_social'],
                        ['route' => 'checklist.index', 'title' => 'Checklist', 'icon' => 'bi bi-list-check', 'feature_flag' => 'is_calendar_setup_enabled', 'permission' => 'calendar.events'],
                        
                        // Asset Management Setup 
                        ['route' => 'asset-type.index', 'title' => 'Asset Types', 'icon' => 'bi bi-box', 'permission' => 'asset_management.setup', 'feature_flag' => 'is_asset_management_setup_enabled'],
                        ['route' => 'asset-category.index', 'title' => 'Asset Categories', 'icon' => 'bi bi-tags', 'permission' => 'asset_management.setup', 'feature_flag' => 'is_asset_management_setup_enabled'],
                        ['route' => 'asset-status.index', 'title' => 'Asset Status', 'icon' => 'bi bi-check2-circle', 'permission' => 'asset_management.setup', 'feature_flag' => 'is_asset_management_setup_enabled'],
                        ['route' => 'supplier.index', 'title' => 'Suppliers', 'icon' => 'bi bi-truck', 'permission' => 'asset_management.setup', 'feature_flag' => 'is_asset_management_setup_enabled'],
                        ['route' => 'assets.index', 'title' => 'Open Assets', 'icon' => 'bi bi-box-seam', 'permission' => 'asset_management.setup', 'feature_flag' => 'is_asset_management_setup_enabled'],
                    ],
                ],
