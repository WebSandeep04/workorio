        ...
        [
            ...
            'sections' => [
                ...
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'subscriptions.index', 'title' => 'Subs & Renewal', 'icon' => 'bi bi-arrow-repeat', 'permission' => 'subscription.view'],
                    ]
                ],
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'contactmanagement.index', 'title' => 'Contact Management', 'icon' => 'bi bi-person-lines-fill', 'permission' => 'contact_management.access'],
                    ]
                ],
                [
                    'key' => 'social_media',
                ...
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'emailmarketing.index', 'title' => 'Email Marketing', 'icon' => 'bi bi-envelope', 'permission' => 'email_marketing.view'],
                    ]
                ],
            ]
        ],
        [
            ...
            'sections' => [
                ...
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'projects.index', 'title' => 'Projects', 'icon' => 'bi bi-kanban', 'permission' => 'projects.view'],
                    ]
                ],
                [
                    'key' => 'tracking',
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'tracking.index', 'title' => 'Tracking', 'icon' => 'bi bi-geo-alt', 'permission' => 'tracking.view'],
                    ]
                ],
                [
                    'key' => 'tasks_reminders',
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['route' => 'tracking.report', 'title' => 'Tracking Report', 'icon' => 'bi bi-geo-alt', 'permission' => 'tracking.report', 'feature_flag' => 'is_tracking_enabled'],
                    ],
                ],
                [
                    'key' => 'documents',
                ...
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'petty-cash.index', 'title' => 'Petty Cash', 'icon' => 'bi bi-cash-stack', 'permission' => 'petty_cash.view'],
                    ]
                ],
                [
                    'key' => 'approvals',
                ...
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'asset-management.index', 'title' => 'Asset Management', 'icon' => 'bi bi-box-seam', 'permission' => 'asset_management.access'],
                    ]
                ],
            ]
        ],
        [
            'key' => 'whatsapp_management',
        ...
        [
            ...
            'sections' => [
                ...
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        // PDF says: Employees, Manage Shifts, Departments, Designations, Employment Types, Entry Types
                        // Wait, "Employees" in setup? It doesn't exist in Software Setup originally, but there's Employees and Manage Shifts under Workforce.
                        // I'll put departments, designations, employment types, entry types here.
                ...
                [
                    ...
                    'roles' => ['admin'],
                    'items' => [
                        ['route' => 'shifts.index', 'title' => 'Shifts', 'icon' => 'bi bi-clock', 'permission' => 'setup.shifts', 'feature_flag' => 'is_attendance_setup_enabled'],
                ...
                [
                    'key' => 'task_workflow_setup',
                    'title' => 'Task & Workflow Setup',
                    'icon' => 'bi bi-diagram-3',
                    'roles' => ['admin'],
                    'items' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        // Whatsapp Template is already under Whatsapp Management, skipping here if we don't duplicate. Wait, PDF says "Whatsapp Template" is under WhatsApp Management -> Templates. 
                        // But then under Communication Setup it has "Client Social Handles, Whatsapp Template". PDF page 5 says:
                        // Communication Setup
