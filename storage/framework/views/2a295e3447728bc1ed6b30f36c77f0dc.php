...
<?php $__env->startSection('page_title', 'State'); ?>
...
<div class="container-fluid px-2">
  <div class="table-search mb-2">
    ...
    <button class="table-search-btn" data-bs-toggle="modal" data-bs-target="#createStateModal">
  ...
  <div class="modern-card data-table-card">
    <div class="modern-card-body">
      <div class="table-responsive">
        <table class="table custom-table" id="salesStateTable">
          <thead>
            <tr>
              <th>State Name</th>
              <th>Actions</th>
          ...
          <tbody>
            <tr>
              <td colspan="2" class="loading-state">
                ...
                <p class="mt-2 mb-0">Loading states...</p>
              </td>
            </tr>
          </tbody>
        </table>
  ...
  <div class="table-range-meta" id="stateRangeInfo">
...
<!-- Create Modal -->
<div class="modal fade modal-modern" id="createStateModal" tabindex="-1" aria-labelledby="createStateModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="createStateModalLabel">
      ...
      <form id="createStateForm">
        <div class="modal-body pt-4 pb-4">
          <?php echo csrf_field(); ?>
          <div class="mb-2">
            <label for="state_name" class="form-label-modern">State Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="state_name" name="state_name" required placeholder="Enter state name">
          </div>
        </div>
...
<!-- Edit Modal -->
<div class="modal fade modal-modern" id="editStateModal" tabindex="-1" aria-labelledby="editStateModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style="font-size: 1.1rem; font-weight: 600;" id="editStateModalLabel">
      ...
      <form id="editStateForm">
        <div class="modal-body pt-4 pb-4">
          ...
          <div class="mb-2">
            <label for="edit_state_name" class="form-label-modern">State Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="edit_state_name" required>
          </div>
        </div>
        <div class="modal-footer">
          <!-- Footer Close button removed as per request -->
...
$(function () {
  ...
  function loadState(page = 1) {
    ...
    $.get(`<?php echo e(route('state.fetch')); ?>?page=${page}&search=${search}`, function (data) {
        ...
        $('#salesStateTable tbody').html(`
          <tr>
            <td colspan="2" class="empty-state">
              ...
              <p>Get started by creating your first state.</p>
            </td>
          </tr>
        `);
            ...
            <td>
              <div class="d-flex gap-2 justify-content-center">
                <button class="btn-action btn-action-edit editBtn"
                  ...
                  data-id="${s.id}" data-name="${s.state_name}" title="Edit">
      ...
      $('#salesStateTable tbody').html(rows);
  ...
  // Close modals when clicking outside (since we removed buttons)
  ...
  $('#createStateForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('state.store')); ?>", {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/state.blade.php ENDPATH**/ ?>