...
<?php $__env->startSection('title', 'Follow Ups'); ?>
<?php $__env->startSection('page_title', 'Follow Ups'); ?>
...
function loadSummaryStats() {
    $.ajax({
        url: '<?php echo e(route("followup.summary-stats")); ?>',
        type: 'GET',
...
function loadStatusCounts() {
    $.ajax({
        url: '<?php echo e(route("followup.status-counts")); ?>',
        type: 'GET',
        success: function(data) {
...
function loadFollowupRecords(page = 1) {
    $.ajax({
        url: '<?php echo e(route("sales.records")); ?>',
        type: 'GET',
...
function loadDateFilteredFollowups(from_date = '', to_date = '', page = 1) {
    $.ajax({
        url: '<?php echo e(route("filterdate")); ?>?page=' + page,
        type: 'POST',
        data: {
            from_date,
            to_date,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/followup.blade.php ENDPATH**/ ?>