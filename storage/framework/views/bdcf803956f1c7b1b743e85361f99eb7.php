...
<?php $__env->startSection('title', 'Unlock Attendance'); ?>
<?php $__env->startSection('page_title', 'Unlock Attendance'); ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="date" id="unlock_date_input" class="form-control" value="<?php echo e(\Carbon\Carbon::today()->toDateString()); ?>">
...
$(document).ready(function() {
    ...
    window.fetchAttendance = function(page = 1) {
        ...
        $.ajax({
            url: "<?php echo e(route('attendance.unlock.fetch')); ?>",
            type: 'GET',
    ...
    window.unlockAttendance = function(id) {
        ...
        $.post("/attendance/unlock/" + id, { _token: '<?php echo e(csrf_token()); ?>' }, function(res) {
    ...
    $('#btnExecuteUnlock').on('click', function() {
        ...
        $.post("<?php echo e(route('attendance.unlock-by-date')); ?>", { 
    ...
    window.bulkUnlock = function() {
        ...
        $.post("<?php echo e(route('attendance.unlock-bulk')); ?>", { _token: '<?php echo e(csrf_token()); ?>', ids: ids }, function(res) {
            if (res.success) fetchAttendance(currentPage);
            else alert(res.message);
        });
    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/attendance/unlock.blade.php ENDPATH**/ ?>