          ...
          <div class="row g-3 mb-2">
            <div class="col-md-6">
                ...
                <div class="d-flex flex-wrap gap-2 mt-1">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="day_<?php echo e($index); ?>" style="font-size: 0.8rem;">
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex flex-wrap gap-2 mt-1">
                    <?php $__currentLoopData = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-check">
                        <input class="form-check-input half-day-checkbox" type="checkbox" name="half_days[]" value="<?php echo e($index); ?>" id="half_day_<?php echo e($index); ?>">
                        <label class="form-check-label" for="half_day_<?php echo e($index); ?>" style="font-size: 0.8rem;">
                            <?php echo e(substr($day, 0, 3)); ?>
