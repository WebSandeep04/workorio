...
(function () {
  ...
  const listUrl = "<?php echo e(route('shifts.list')); ?>";
  const storeUrl = "<?php echo e(route('shifts.store')); ?>";
  ...
  function saveShift(){
    ...
    const url = id ? `<?php echo e(url('/shifts')); ?>/${id}` : storeUrl;
