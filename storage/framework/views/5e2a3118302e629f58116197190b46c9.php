...
(function () {
    ...
    function collectEmployeeForm() {
        ...
        return {
            ...
            shift_effective_date: $('#employee_shift_effective_date').val(),
    ...
    function openEmployeeModal(data) {
        ...
        if (data) {
            $('#shift_container').hide();
        } else {
            $('#shift_container').show();
        }
        ...
        if (data) {
            ...
            $('#employee_shift_effective_date').val(new Date().toISOString().split('T')[0]); // Default to today
            ...
            <div class="modal-body">
                <form id="employeeForm">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-8" id="shift_container">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\workorio\resources\views/employees/index.blade.php ENDPATH**/ ?>