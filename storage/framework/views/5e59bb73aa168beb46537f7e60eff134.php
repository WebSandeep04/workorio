    ...
    <div class="neo-metric-grid">
        ...
        <div class="neo-metric-card">
            <div class="metric-icon icon-amber">
                <img src="<?php echo e(asset('img/icons/underprocess.png')); ?>" alt="Hourglass">
            </div>
            <div class="metric-content">
                <p>Under Process</p>
        ...
        <div class="neo-metric-card-blue">
            <div class="metric-icon icon-violet">
                <img src="<?php echo e(asset('img/icons/all.png')); ?>" alt="All Leads">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Don't Delete\laravel\leadmanagement (akrati ui work)\resources\views/dashboard.blade.php ENDPATH**/ ?>