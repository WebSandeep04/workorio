...
<?php $__env->startSection('title', 'Calendar Status'); ?>
<?php $__env->startSection('page_title', 'Calendar Status'); ?>
...
$(function () {
  ...
  function loadStatuses(page = 1) {
    ...
    $.get(`<?php echo e(route('calendar-status.fetch')); ?>?page=${page}&search=${search}`)
      .done(function (data) {
  ...
  $('#createStatusForm').on('submit', function (e) {
    ...
    $.post("<?php echo e(route('calendar-status.store')); ?>", {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/calendar/status.blade.php ENDPATH**/ ?>