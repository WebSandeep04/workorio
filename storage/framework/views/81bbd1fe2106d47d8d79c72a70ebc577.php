...
<?php $__env->startSection('page_title', 'Payroll Details - ' . date('F', mktime(0, 0, 0, $payroll->month, 1)) . ' ' . $payroll->year); ?>
...
<div class="container-fluid px-2">
  <div class="mb-3 d-flex align-items-center justify-content-between">
    <div>
        <a href="<?php echo e(route('payroll.process.index')); ?>" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back</a>
        <span class="ms-2 fw-bold">Batch ID: #<?php echo e($payroll->id); ?> | Status: <?php echo e($payroll->status); ?></span>
    </div>
  </div>
...
$(function () {
  const baseUrl = "<?php echo e(route('payroll.process.show', $payroll->id)); ?>";
  let searchTimeout;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/payroll/show.blade.php ENDPATH**/ ?>