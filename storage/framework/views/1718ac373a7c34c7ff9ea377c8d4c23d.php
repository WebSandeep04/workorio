...
<?php $__env->startSection('title', 'Checklist'); ?>
<?php $__env->startSection('page_title', 'Checklist'); ?>
...
(function(){
    ...
    function loadChecklists(page = 1){
        ...
        $.get(`<?php echo e(route('checklist.fetch')); ?>?page=${page}&search=${search}`).done(function(data){
    ...
    $('#createChecklistForm').on('submit', function(e){
        ...
        $.post("<?php echo e(route('checklist.store')); ?>", payload).done(function(){
    ...
    $('#confirmDeleteBtn').click(function(){
        ...
        $.ajax({ url: `/checklist/${id}`, method:'DELETE', data:{ _token: '<?php echo e(csrf_token()); ?>' } })
            .done(function(){
    ...
    function loadOptions(checklistId){
        ...
        $.get("<?php echo e(route('checklist.options.fetch')); ?>", { checklist_id: checklistId }).done(function(rows){
            let html='';
    ...
    $('#addOption').on('click', function(){
        ...
        $.post("<?php echo e(route('checklist.options.store')); ?>", payload).done(function(){
            $('#option_name').val('');
            $('#option_sort').val('0');
            $('#option_active').prop('checked', true);
    ...
    $(document).on('click', '.del-option', function(){
        ...
        $.ajax({ url:`/checklist/options/${id}`, method:'DELETE', data:{ _token: '<?php echo e(csrf_token()); ?>' } })
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/checklist/index.blade.php ENDPATH**/ ?>