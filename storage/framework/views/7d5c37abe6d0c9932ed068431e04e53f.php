...
<?php $__env->startSection('page_title', 'Places'); ?>
...
$(function () {
  ...
  function loadPlaces(page = 1) {
    ...
    $.get(`<?php echo e(route('places.list')); ?>`, function (data) {
  ...
  $('#createPlaceForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('places.store')); ?>", {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dont Delete\laravel\leadmanagement (akrati ui work)\resources\views/places/index.blade.php ENDPATH**/ ?>