<?php $__env->startSection('title', "Today's Calling"); ?>
<?php $__env->startSection('page_title', "Today's Calling"); ?>
...
$(function () {
    ...
    function loadFilterOptions() {
        return $.get('<?php echo e(route("calling.todays.filter-options")); ?>').done((resp) => {
    ...
    function loadCities(stateId) {
        ...
        const url = '<?php echo e(route("calling.todays.cities", ["stateId" => 0])); ?>'.replace(/0$/, String(stateId));
        $.get(url).done((cities) => {
    ...
    function loadCallings(page = 1) {
        currentPage = page;
        $.get('<?php echo e(route("calling.todays.data")); ?>?page=' + page).done((data) => {
    ...
    function applyFilters(page = 1) {
        ...
        $.post('<?php echo e(route("calling.todays.filter")); ?>?page=' + page, {
            name: name,
            state_id: stateId,
            city_id: cityId,
    ...
    $(document).on('change', '.calling-type-select', function () {
        ...
        $.post('<?php echo e(route("calling.update-type")); ?>', {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Don't Delete\laravel\leadmanagement (akrati ui work)\resources\views/calling/todayscalling.blade.php ENDPATH**/ ?>