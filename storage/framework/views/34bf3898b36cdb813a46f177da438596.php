...
<div class="container-fluid px-2">
  <div class="table-search mb-2">
    ...
    <button class="table-search-btn" data-bs-toggle="modal" data-bs-target="#createProductModal">
      <i class="bi bi-plus me-1"></i>Create Product
    </button>
  </div>
  ...
  <div class="modern-card data-table-card">
    <div class="modern-card-body">
      <div class="table-responsive">
        <table class="table custom-table" id="salesProductTable">
          <thead>
            <tr>
              <th>Product Name</th>
              <th>Actions</th>
  ...
  <div class="table-range-meta" id="productRangeInfo">
...
<div class="modal fade modal-modern" id="createProductModal" tabindex="-1" aria-labelledby="createProductModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="createProductModalLabel">
      ...
      <form id="createProductForm">
        <div class="modal-body pt-4 pb-4">
          <?php echo csrf_field(); ?>
          <div class="mb-2">
            <label for="product_name" class="form-label-modern">Product Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="product_name" name="product_name" required placeholder="Enter product name">
          </div>
        </div>
...
<!-- Edit Product Modal -->
<div class="modal fade modal-modern" id="editProductModal" tabindex="-1" aria-labelledby="editProductModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="editProductModalLabel">
      ...
      <form id="editProductForm">
        <div class="modal-body pt-4 pb-4">
          ...
          <div class="mb-2">
            <label for="edit_product_name" class="form-label-modern">Product Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="edit_product_name" required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn-modern btn-modern-primary w-100 justify-content-center" style="background: #434AFA; color: white;">
...
$(function () {
  ...
  function loadProduct(page = 1) {
    ...
    $.get(`<?php echo e(route('product.fetch')); ?>?page=${page}&search=${search}`, function (data) {
          ...
          <tr style="animation-delay: ${i * 0.1}s;">
            ...
            <td>
              <div class="d-flex gap-2 justify-content-center">
                <button class="btn-action btn-action-edit editBtn" data-id="${s.id}" data-name="${s.product_name}" title="Edit">
      ...
      $('#salesProductTable tbody').html(`
        <tr>
          <td colspan="2" class="text-danger text-center py-4">
            ...
            <p class="mt-2 mb-0">Failed to load products. Please try again.</p>
          </td>
        </tr>
      `);
    });
  ...
  $('#createProductForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('product.store')); ?>", {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/product.blade.php ENDPATH**/ ?>