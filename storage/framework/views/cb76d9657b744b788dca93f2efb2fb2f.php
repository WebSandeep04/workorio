...
<div class="main-border">
    ...
    <div class="bank-details">
        <?php echo $settings->bank_details ?? 'Bank Details: &nbsp;&nbsp; Bank Name: Bank Of India &nbsp;&nbsp; Account Number: 051630150000037 &nbsp;&nbsp; IFSC Code: BKID0000516'; ?>
    ...
    <div class="payment-terms">
        ...
        <?php if(!empty($settings->payment_terms)): ?>
            <ol>
                <?php $__currentLoopData = explode("\n", str_replace("\r", "", $settings->payment_terms)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(trim($term) !== ''): ?>
                        <li <?php if($index === 0): ?> style="color: red;" <?php endif; ?>><?php echo e(trim($term)); ?></li>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ol>
        <?php else: ?>
