                ...
                <div class="modal-body pt-4 pb-4">
                    ...
                    <div class="modal-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label for="sow_document" class="form-label-modern">SOW Document</label>
                                <input type="file" class="form-control form-control-modern" id="sow_document" name="sow_document" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                ...
                <div class="modal-body pt-4 pb-4">
                    ...
                    <div class="modal-section">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-12">
                                <label for="edit_sow_document" class="form-label-modern">SOW Document</label>
                                <input type="file" class="form-control form-control-modern" id="edit_sow_document" name="sow_document" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                                <div id="edit_sow_link_container" class="mt-1"></div>
                                <small class="text-muted">Upload new SOW to replace existing one (PDF, Doc, Images)</small>
                            </div>
                        </div>
                    </div>
...
$(function () {
        ...
        $.get(`<?php echo e(route('customer-project.fetch')); ?>?page=${page}&search=${search}`, function (data) {
            ...
            $.each(data.data, function (i, cp) {
                ...
                rows += `<tr style="animation-delay: ${i * 0.1}s;">
                    ...
                    <td>
                        ${cp.sow_path 
                            ? `<a href="/storage/${cp.sow_path}" target="_blank" class="btn btn-sm btn-outline-primary" title="View SOW">
                    ...
                    <td>
                      <div class="d-flex gap-2 justify-content-center">
                        <button class="btn-action btn-action-edit editBtn" data-id="${cp.id}" 
                                ...
                                data-template-name="${templateNameAttr}" data-sow-path="${cp.sow_path || ''}" title="Edit">
    ...
    $(document).on('click', '.editBtn', function () {
        ...
        const sowPath = $(this).data('sow-path');
        if (sowPath) {
            $('#edit_sow_link_container').html(`<a href="/storage/${sowPath}" target="_blank" class="text-primary small"><i class="bi bi-file-earmark-text me-1"></i>View Current SOW</a>`);
        } else {
            $('#edit_sow_link_container').empty();
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\workorio\resources\views/customer-project/index.blade.php ENDPATH**/ ?>