...
<div class="modal fade modal-modern" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form id="changePasswordForm">
        <div class="modal-header">
          <h5 class="modal-title" style="font-size: 1.1rem; font-weight: 600;" id="changePasswordModalLabel">
        ...
        <div class="modal-body pt-4 pb-4">
            ...
            <div class="mb-3">
                <label for="new_password" class="form-label-modern">New Password <span class="text-danger">*</span></label>
                <input type="password" class="form-control form-control-modern" id="new_password" name="password" required placeholder="Enter new password">
            </div>
            <div class="mb-3">
                <label for="new_password_confirmation" class="form-label-modern">Confirm Password <span class="text-danger">*</span></label>
                <input type="password" class="form-control form-control-modern" id="new_password_confirmation" name="password_confirmation" required placeholder="Confirm new password">
            </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn-modern btn-modern-primary w-100 justify-content-center" style="background: #434AFA; color: white;">
            ...
            <tr style="animation-delay: ${i * 0.1}s;">
              ...
              <td>
                <div class="d-flex gap-2 justify-content-center">
                  ...
                  <button class="btn-action btn-action-edit" style="background: #ffc107 !important; border-radius: 4px;" onclick="openPasswordModal(${user.id})" title="Change Password">
...
$('#changePasswordForm').submit(function (e) {
    ...
    $.ajax({
        ...
        error: function(xhr) {
            $btn.prop('disabled', false).html('<i class="bi bi-check-circle"></i> Update Password');
            const errorMsg = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : 'Failed to update password.';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\workorio\resources\views/user.blade.php ENDPATH**/ ?>