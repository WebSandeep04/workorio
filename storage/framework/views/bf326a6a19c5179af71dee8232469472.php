...
<div class="container-fluid px-2">
  <div class="table-search mb-2">
    ...
    <button class="table-search-btn" data-bs-toggle="modal" data-bs-target="#createCustomerModal">
      <i class="bi bi-plus me-1"></i>Create Customer
    </button>
  </div>
  ...
  <div class="table-range-meta" id="customerRangeInfo">
...
<div class="modal fade modal-modern" id="createCustomerModal" tabindex="-1" aria-labelledby="createCustomerModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="createCustomerModalLabel">
      ...
      <form id="createCustomerForm">
        <div class="modal-body pt-4 pb-4">
          <?php echo csrf_field(); ?>
          <div class="mb-3">
            <label for="name" class="form-label-modern">Customer Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="name" name="name" required placeholder="Enter customer name">
          </div>
          <div class="mb-3">
            <label for="email" class="form-label-modern">Email</label>
            <input type="email" class="form-control form-control-modern" id="email" name="email" placeholder="example@domain.com">
          </div>
          <div class="mb-3">
            <label for="phone" class="form-label-modern">Phone</label>
            <input type="text" class="form-control form-control-modern" id="phone" name="phone" placeholder="Enter phone number">
          </div>
          <div class="mb-3">
            <label for="company_name" class="form-label-modern">Company Name</label>
            <input type="text" class="form-control form-control-modern" id="company_name" name="company_name" placeholder="Enter company name">
          </div>
          <div class="mb-3">
            <label for="address" class="form-label-modern">Address</label>
            <textarea class="form-control form-control-modern" id="address" name="address" rows="3" placeholder="Enter full address"></textarea>
          </div>
        </div>
...
<!-- Edit Customer Modal -->
<div class="modal fade modal-modern" id="editCustomerModal" tabindex="-1" aria-labelledby="editCustomerModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="editCustomerModalLabel">
      ...
      <form id="editCustomerForm">
        <div class="modal-body pt-4 pb-4">
          ...
          <div class="mb-3">
            <label for="edit_name" class="form-label-modern">Customer Name <span class="text-danger">*</span></label>
          ...
          <div class="mb-3">
            ...
            <input type="email" class="form-control form-control-modern" id="edit_email">
          </div>
          <div class="mb-3">
            <label for="edit_phone" class="form-label-modern">Phone</label>
            <input type="text" class="form-control form-control-modern" id="edit_phone">
          </div>
          <div class="mb-3">
            <label for="edit_company_name" class="form-label-modern">Company Name</label>
            <input type="text" class="form-control form-control-modern" id="edit_company_name">
          </div>
          <div class="mb-3">
            <label for="edit_address" class="form-label-modern">Address</label>
            <textarea class="form-control form-control-modern" id="edit_address" rows="3"></textarea>
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn-modern btn-modern-primary w-100 justify-content-center" style="background: #434AFA; color: white;">
...
<div class="modal fade modal-modern" id="deleteCustomerModal" tabindex="-1" aria-labelledby="deleteCustomerModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="deleteCustomerModalLabel">
      ...
      <div class="modal-body pt-4 pb-4">
        <p class="mb-0 text-center fs-6">Are you sure you want to delete this customer?</p>
      </div>
      <div class="modal-footer">
...
$(function () {
  ...
  function loadCustomers(page = 1) {
    ...
    $.get(`<?php echo e(route('customer.fetch')); ?>?page=${page}&search=${search}`, function (data) {
      ...
      let rows = '';
      $.each(data.data, function (i, customer) {
        rows += `
          <tr style="animation-delay: ${i * 0.1}s;">
            ...
            <td>
              <div class="d-flex gap-2 justify-content-center">
                <button class="btn-action btn-action-edit editBtn" data-id="${customer.id}" 
                        data-name="${customer.name}" data-email="${customer.email || ''}" 
                        data-phone="${customer.phone || ''}" data-company="${customer.company_name || ''}" 
                        data-address="${customer.address || ''}" title="Edit">
                  <i class="bi bi-pencil"></i>
                </button>
                <button class="btn-action btn-action-delete deleteBtn" data-id="${customer.id}" title="Delete">
                  <i class="bi bi-trash"></i>
                </button>
              </div>
            </td>
  ...
  $('#createCustomerForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('customer.store')); ?>", {
      name: $('#name').val(),
      email: $('#email').val(),
      phone: $('#phone').val(),
      ...
      $btn.prop('disabled', false).html('<i class="bi bi-check-circle"></i> Create Customer');
    });
  });
  ...
  $('#editCustomerForm').submit(function (e) {
    ...
    $.ajax({
      ...
      always: function() {
        $btn.prop('disabled', false).html('<i class="bi bi-check-circle"></i> Update Customer');
      }
    });
  });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/customer/index.blade.php ENDPATH**/ ?>