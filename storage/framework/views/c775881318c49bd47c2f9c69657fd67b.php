...
<?php $__env->startSection('title', 'All Data - Today Completed'); ?>
<?php $__env->startSection('page_title', 'All Data - Today Completed'); ?>
  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon icon-emerald">
        <img src="<?php echo e(asset('img/icons/checklist.png')); ?>" alt="Completed" onerror="this.onerror=null;this.src='<?php echo e(asset('img/icons/double-check.png')); ?>';">
      </div>
...
function loadData(page = 1) {
  $.ajax({
    url: `<?php echo e(route('alldata.today-completed.data')); ?>?page=${page}`,
    method: 'GET',
    success: function (response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Don't Delete\laravel\leadmanagement (akrati ui work)\resources\views/alldata/today-completed.blade.php ENDPATH**/ ?>