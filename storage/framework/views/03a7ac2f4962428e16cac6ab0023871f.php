...
<?php $__env->startSection('page_title', 'Holiday Management'); ?>
...
$(function () {
  ...
  function loadHolidays(page = 1) {
    ...
    $.get(`<?php echo e(route('holiday.fetch')); ?>?page=${page}&search=${search}`, function (data) {
  ...
  $('#addHolidayForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('holiday.store')); ?>", {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/holiday/index.blade.php ENDPATH**/ ?>