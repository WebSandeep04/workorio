...
<?php $__env->startSection('title', 'Status-Checklist Links'); ?>
<?php $__env->startSection('page_title', 'Status-Checklist Links'); ?>
...
(function(){
  ...
  function loadData(page = 1){
    ...
    $.get(`<?php echo e(route('calendar-status-checklist.fetch')); ?>?page=${page}&search=${search}`).then(function(data){
  ...
  $('#saveStatusChecklist').on('click', function(){
    ...
    $.ajax({
      url: "<?php echo e(route('calendar-status-checklist.update')); ?>",
      method: 'POST',
      data: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/calendar/status-checklist.blade.php ENDPATH**/ ?>