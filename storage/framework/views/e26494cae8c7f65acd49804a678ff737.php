            ...
            if (data.data.length === 0) {
                ...
                data.data.forEach(function (record) {
                    ...
                    if (record.latest_remark) {
                        ...
                        remark = `<a href="/remark?sales_record_id=${record.id}" title="${fullRemark.replace(/"/g, '&quot;')}">${shortRemark}</a>`;
                    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/assignedleads.blade.php ENDPATH**/ ?>