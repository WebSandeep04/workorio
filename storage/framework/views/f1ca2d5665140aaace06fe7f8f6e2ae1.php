        ...
        <form id="quotationSetupForm">
            ...
            <div class="tab-content" id="tab-legal">
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea class="form-control-modern" id="payment_terms" name="payment_terms" rows="6" placeholder="Enter terms separated by new lines..."></textarea>
                    <small class="text-muted">Enter any default payment terms or condition clauses to show on your quotation PDFs.</small>
                </div>
            </div>
