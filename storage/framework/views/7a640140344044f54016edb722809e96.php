...
<?php $__env->startSection('title', 'Worklog History'); ?>
<?php $__env->startSection('page_title', 'Worklog History'); ?>
...
<div class="container-fluid px-2 mt-2">
    ...
    <div id="noDataMessage" class="text-center py-5 d-none">
        ...
        <a href="<?php echo e(route('worklog')); ?>" class="btn btn-sm btn-primary" style="background:#434afa; border:none; border-radius:0;">
...
function loadWorklogs(page = 1) {
    $.get("<?php echo e(route('worklog-history.fetch')); ?>", { page: page }, function (response) {
...
function loadStats() {
    $.get("<?php echo e(route('worklog-history.stats')); ?>", function (data) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/worklog/history.blade.php ENDPATH**/ ?>