...
<div class="container-fluid calling-status-page px-2">
    <div class="dashboard-header mb-3">
        <h4 class="fw-bold" style="font-family: Montserrat; color: #101828;"><?php echo e($title); ?></h4>
...
function loadTableData(page) {
    $.ajax({
        url: '<?php echo e($data_url); ?>?page=' + page,
                ...
                resp.data.forEach(item => {
                    tbody.append(`
                        <tr>
                            ...
                            <td title="${item.latest_remark || ''}">
                                <span class="text-muted small">${item.latest_remark ? (item.latest_remark.length > 20 ? item.latest_remark.substring(0,20)+'...' : item.latest_remark) : '-'}</span>
                            </td>
                            <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/calling/status_table.blade.php ENDPATH**/ ?>