<?php $__env->startSection('title', 'Import New List'); ?>
<?php $__env->startSection('page_title', 'Lead Ingestion'); ?>
...
<div class="container-fluid px-2">
    <div class="import-wizard">
        ...
        <form action="<?php echo e(route('calling.list.store')); ?>" method="POST" enctype="multipart/form-data" id="importForm">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/calling/list/create.blade.php ENDPATH**/ ?>