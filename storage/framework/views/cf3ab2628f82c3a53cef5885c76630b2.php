    ...
    <div class="table-search mb-2">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <input type="month" id="monthFilter" class="form-control form-control-sm shadow-sm" 
                   value="<?php echo e(date('Y-m')); ?>" style="width: auto; border-radius: 4px; border: 1px solid #e5e7eb;">
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\workorio\resources\views/attendance/history.blade.php ENDPATH**/ ?>