...
<?php $__env->startSection('title', 'All Data - Today Pending'); ?>
<?php $__env->startSection('page_title', 'All Data - Today Pending'); ?>
  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon icon-rose">
        <img src="<?php echo e(asset('img/icons/pending.png')); ?>" alt="Pending" onerror="this.onerror=null;this.src='<?php echo e(asset('img/icons/clock.png')); ?>';">
      </div>
      <div class="summary-card-content">
        <div class="summary-card-label">Today Pending</div>
        <div class="summary-card-value" id="totalTodayPendingCard">0</div>
      </div>
    </div>
  </div>
...
function loadSummaryStats() {
  $.ajax({
    ...
    success: function(response) {
      $('#totalTodayPendingCard').text(response.today_pending || 0);
    },
...
function loadData(page = 1) {
  $.ajax({
    url: `<?php echo e(route('alldata.today-pending.data')); ?>?page=${page}`,
    method: 'GET',
    success: function (response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Don't Delete\laravel\leadmanagement (akrati ui work)\resources\views/alldata/today-pending.blade.php ENDPATH**/ ?>