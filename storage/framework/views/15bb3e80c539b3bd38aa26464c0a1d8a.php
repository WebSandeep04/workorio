...
$(document).ready(function(){
 ...
 function prospect(){
  $.ajax({
        url: "<?php echo e(route('getProspectus')); ?>",
        type: 'GET',
...
// get cities
 $('#state').on('change', function () {
    ...
    // get all cities
      $.ajax({
        url: "<?php echo e(route('allcity')); ?>", // Define this route in your web.php
        type: "GET",
        success: function (data) {
            $('#city').empty().append('<option value="">Select City</option>');
    ...
    // business type 
      ...
      $.ajax({
        url: "<?php echo e(route('getbusiness')); ?>", // Define this route in your web.php
        type: "GET",
        success: function (data) {
    ...
    // get sources
      ...
      $.ajax({
        url: "<?php echo e(route('getsource')); ?>", // Define this route in your web.php
        type: "GET",
        success: function (data) {
...
// get product
      ...
      $.ajax({
        url: "<?php echo e(route('getproduct')); ?>", // Define this route in your web.php
        type: "GET",
        success: function (data) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/lead.blade.php ENDPATH**/ ?>