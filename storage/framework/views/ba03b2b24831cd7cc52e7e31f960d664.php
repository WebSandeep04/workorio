        ...
        <tbody>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $payload['worklogs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr style="background-color:<?php echo e($bg_color); ?>;">
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#0f172a; font-weight:600; vertical-align:top;"><?php echo e(htmlspecialchars($row['user_name'])); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#334155; vertical-align:top; white-space:normal; min-width:120px;"><?php echo e($company_name); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#334155; vertical-align:top;"><?php echo e(htmlspecialchars($row['service_name'] ?? '-')); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#334155; vertical-align:top;"><?php echo e(htmlspecialchars($row['customer_project_name'] ?? '-')); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#334155; vertical-align:top;"><?php echo e(htmlspecialchars($row['module_name'] ?? '-')); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#0f172a; text-align:center; font-weight:600; vertical-align:top;"><?php echo e(htmlspecialchars($row['hours'] ?? '0')); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#0f172a; text-align:center; font-weight:600; vertical-align:top;"><?php echo e(htmlspecialchars($row['minutes'] ?? '0')); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#334155; white-space: normal; line-height: 1.4; vertical-align:top; min-width:150px;"><?php echo $desc; ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#334155; text-align:center; vertical-align:top;"><?php echo e($rating); ?></td>
                    <td style="padding:3px; border-right:1px solid #e2e8f0; color:#334155; vertical-align:top;"><?php echo e($rating_remark); ?></td>
                </tr>
...
<?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/emails/worklog_report_today.blade.php ENDPATH**/ ?>