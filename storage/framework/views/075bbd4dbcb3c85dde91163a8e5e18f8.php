<?php $__env->startSection('title', 'My Gen Leads'); ?>
<?php $__env->startSection('page_title', 'My Gen Leads'); ?>
...
<div class="container-fluid px-2">
  ...
  <div class="summary-cards">
    <div class="summary-card card-1">
      <div class="summary-card-icon icon-sunrise"><img src="<?php echo e(asset('img/icons/call.png')); ?>" alt="Calls"></div>
    ...
    <div class="summary-card card-2">
      <div class="summary-card-icon icon-amber"><img src="<?php echo e(asset('img/icons/underprocess.png')); ?>" alt="Under Process"></div>
    ...
    <div class="summary-card card-3">
      <div class="summary-card-icon icon-emerald"><img src="<?php echo e(asset('img/icons/tick.png')); ?>" alt="Completed"></div>
    ...
    <div class="summary-card card-4">
      <div class="summary-card-icon icon-rose"><img src="<?php echo e(asset('img/icons/pending.png')); ?>" alt="Pending"></div>
    ...
    <div class="summary-card card-5">
      <div class="summary-card-icon icon-sky"><img src="<?php echo e(asset('img/icons/new.png')); ?>" alt="New"></div>
...
function loadSummaryStats() {
    $.get('<?php echo e(route("leadgen.my.summary-stats")); ?>', d => {
...
function loadStatusCounts() {
    $.get('<?php echo e(route("leadgen.my.status-counts")); ?>', data => {
...
function loadGenLeads(page = 1) {
    const filters = {
        _token: '<?php echo e(csrf_token()); ?>', status_id: $('#sales_status').val(), city_id: $('#city').val(), state_id: $('#state').val(), business_type_id: $('#business_type').val(), lead_source_id: $('#lead_source').val(), products_id: $('#product_type').val(), search: $('#search').val(), per_page: 10
    };
    $.post('<?php echo e(route("leadgen.my.filter")); ?>?page=' + page, filters, d => {
        let h = '';
...
function fetchProspectuses() {
    $.get('<?php echo e(route("getProspectus")); ?>', data => {
...
$(document).ready(() => {
    ...
    $.get('<?php echo e(route("leadgen.my.team-members")); ?>', d => { 
        window.allUsers = d; 
        loadGenLeads();
    ...
    // Populate selects
    $.get("<?php echo e(route('getStatuses')); ?>", d => { 
    ...
    $.get("<?php echo e(route('getbusiness')); ?>", d => {
    ...
    $.get("<?php echo e(route('getsource')); ?>", d => {
    ...
    $.get("<?php echo e(route('getproduct')); ?>", d => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/leadgen/my.blade.php ENDPATH**/ ?>