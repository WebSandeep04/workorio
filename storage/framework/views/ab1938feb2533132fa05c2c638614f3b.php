<?php $__env->startSection('title', 'Statutory Rules'); ?>
<?php $__env->startSection('page_title', 'Statutory Rules'); ?>
...
$(function () {
  const baseUrl = "<?php echo e(route('payroll.statutory.index')); ?>";
  let allRules = [];
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/payroll/statutory.blade.php ENDPATH**/ ?>