...
<?php $__env->startSection('title', 'IndiaMART Junk Leads'); ?>
<?php $__env->startSection('page_title', 'IndiaMART Junk Leads'); ?>
...
(function () {
  ...
  function loadJunk(page = 1) {
    ...
    $.ajax({
      url: '<?php echo e(route("indiamart.junk.fetch")); ?>?page=' + page,
      type: 'GET',
      data: params,
  ...
  $(document).on('click', '.imj-restore-btn', function () {
    ...
    $.ajax({
      url: '<?php echo e(route("indiamart.junk.restore")); ?>',
      type: 'POST',
      data: { lead_id: leadId },
      success: function (resp) {
  ...
  $(document).on('click', '#imjConfirmDeleteBtn', function () {
    ...
    $.ajax({
      url: '<?php echo e(route("indiamart.junk.delete")); ?>',
      type: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/indiamart/junk.blade.php ENDPATH**/ ?>