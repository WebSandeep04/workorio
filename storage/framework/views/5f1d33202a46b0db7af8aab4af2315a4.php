...
<?php $__env->startSection('page_title', 'WhatsApp Campaigns'); ?>
...
<script>
    ...
    function loadCampaigns(page = 1) {
        $.ajax({
            url: `<?php echo e(route('whatsapp-campaigns.fetch')); ?>?page=${page}`,
            type: 'POST',
    ...
    $('#createCampaignForm').submit(function(e) {
        ...
        $.ajax({
            url: `<?php echo e(route('whatsapp-campaigns.store')); ?>`,
            type: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/whatsapp_campaigns/index.blade.php ENDPATH**/ ?>