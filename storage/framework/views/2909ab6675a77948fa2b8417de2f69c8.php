...
<div class="container-fluid px-2">
    ...
    <div class="d-flex align-items-center mb-3">
        <a href="<?php echo e(route('projects.index')); ?>" class="back-btn">
            <i class="bi bi-arrow-left"></i> Back to Projects
        </a>
        <h5 class="mb-0 fw-bold" style="font-family: Montserrat;"><?php echo e($project->project_name); ?> <span class="text-muted fs-6">(<?php echo e($project->customer->name); ?>)</span></h5>
    </div>
