...
<?php $__env->startSection('title', 'Calling Types Management'); ?>
<?php $__env->startSection('page_title', 'Calling Types Management'); ?>
...
function loadCallingTypes(page = 1) {
    ...
    $.ajax({
        url: '<?php echo e(route("calling-type.fetch")); ?>?page=' + page + '&search=' + encodeURIComponent(search),
        type: 'GET',
...
$('#callingTypeForm').on('submit', function(e) {
    ...
    const url = id ? `<?php echo e(route("calling-type.update", ":id")); ?>`.replace(':id', id) : '<?php echo e(route("calling-type.store")); ?>';
...
$(document).on('click', '.edit-btn', function() {
    ...
    $.ajax({
        url: `<?php echo e(route("calling-type.edit", ":id")); ?>`.replace(':id', id),
        type: 'GET',
        success: function(response) {
...
$('#confirmDelete').on('click', function() {
    if (deleteId) {
        ...
        $.ajax({
            url: `<?php echo e(route("calling-type.destroy", ":id")); ?>`.replace(':id', deleteId),
            type: 'DELETE',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content')
            },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/calling/callingtype.blade.php ENDPATH**/ ?>