  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon icon-emerald">
        <img src="<?php echo e(asset('img/icons/completed.png')); ?>" alt="Completed" onerror="this.onerror=null;this.src='<?php echo e(asset('img/icons/call.png')); ?>';">
      </div>
      <div class="summary-card-content">
        <div class="summary-card-label">Today Completed</div>
        <div class="summary-card-value" id="totalCompletedCard">0</div>
      </div>
    </div>
  </div>
...
function loadTotalCompleted() {
  $.ajax({
    url: '/todaycompleted',
    method: 'GET',
    success: function(response) {
      $('#totalCompletedCard').text(response.todaycompleted || 0);
    },
...
function loadFollowups(page = 1) {
  $.ajax({
    url: `/todaycompletedfollowupstabledata?page=${page}`,
    method: 'GET',
    success: function (response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Don't Delete\laravel\leadmanagement (akrati ui work)\resources\views/todaycompletedtable.blade.php ENDPATH**/ ?>