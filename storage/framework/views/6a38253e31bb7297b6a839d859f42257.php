...
<div class="loginBox">
    <div class="login-card">
        ...
        <p class="text-center text-muted mb-4">
            Hello <strong><?php echo e(session('user_name')); ?></strong>,<br>
        ...
        <form method="POST" action="<?php echo e(url('/reset-password')); ?>">
            ...
            <input type="hidden" name="otp" value="<?php echo e(session('verified_otp')); ?>">
...
<?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>