...
<?php $__env->startSection('page_title', 'Calendar Events'); ?>
...
<div class="container-fluid px-2">
  <div class="table-search mb-2">
    ...
    <button class="table-search-btn" data-bs-toggle="modal" data-bs-target="#createEventModal">
...
<!-- Create Event Modal -->
<div class="modal fade modal-modern" id="createEventModal" tabindex="-1" aria-labelledby="createEventModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div class="modal-content">
      ...
      <form id="createEventForm">
        <div class="modal-body pt-4 pb-4">
          <?php echo csrf_field(); ?>
          <div class="mb-3">
            <label for="event_name" class="form-label-modern">Event Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="event_name" required>
          </div>
          <div class="mb-3">
            <label for="event_date" class="form-label-modern">Date <span class="text-muted small">(Optional)</span></label>
            <input type="date" class="form-control form-control-modern" id="event_date">
          </div>
        </div>
...
<!-- Edit Event Modal -->
<div class="modal fade modal-modern" id="editEventModal" tabindex="-1" aria-labelledby="editEventModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form id="editEventForm">
        <div class="modal-body pt-4 pb-4">
          ...
          <div class="mb-3">
            <label for="edit_event_name" class="form-label-modern">Event Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="edit_event_name" required>
          </div>
          <div class="mb-3">
            <label for="edit_event_date" class="form-label-modern">Date <span class="text-muted small">(Optional)</span></label>
            <input type="date" class="form-control form-control-modern" id="edit_event_date">
          </div>
        </div>
        <div class="modal-footer">
...
<div class="modal fade modal-modern" id="deleteEventModal" tabindex="-1" aria-labelledby="deleteEventModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
...
$(function () {
  ...
  function loadEvents(page = 1) {
    ...
    $.get(`<?php echo e(route('calendar-events.fetch')); ?>?page=${page}&search=${search}`)
      .done(function (data) {
  ...
  $('#createEventForm').on('submit', function (e) {
    ...
    $.post("<?php echo e(route('calendar-events.store')); ?>", {
      name: $('#event_name').val(),
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/calendar/events.blade.php ENDPATH**/ ?>