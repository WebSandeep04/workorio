...
<?php $__env->startSection('title', 'Expenses Setup'); ?>
<?php $__env->startSection('page_title', 'Expenses Setup'); ?>
...
$(function () {
  ...
  function loadExpenses(page = 1) {
    ...
    $.get(`<?php echo e(route('expenses.fetch')); ?>?page=${page}&search=${search}`, function (data) {
  ...
  $('#createExpenseForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('expenses.store')); ?>", {
      name: $('#name').val(),
      price: $('#price').val(),
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/expenses.blade.php ENDPATH**/ ?>