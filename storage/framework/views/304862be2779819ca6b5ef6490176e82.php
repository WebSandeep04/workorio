...
<?php $__env->startSection('title', 'Entry Types Management'); ?>
<?php $__env->startSection('page_title', 'Entry Types Management'); ?>
...
function loadEntryTypes(page = 1) {
    ...
    $.ajax({
        url: `<?php echo e(route("entry-type.fetch")); ?>?page=${page}&search=${search}`,
        method: 'GET',
...
function submitForm() {
    ...
    const url = currentEntryTypeId 
        ...
        : '<?php echo e(route("entry-type.store")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/entry-type/index.blade.php ENDPATH**/ ?>