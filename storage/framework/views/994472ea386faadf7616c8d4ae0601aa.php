...
<?php $__env->startSection('title', 'Manage Category Fields'); ?>
<?php $__env->startSection('page_title', 'Configuration: ' . $category->name); ?>
...
<div class="container-fluid">
    <!-- <div class="config-header">
        <a href="<?php echo e(route('asset-category.index')); ?>" class="back-link">
...
$(function() {
    ...
    $('#fieldsForm').submit(function(e) {
        ...
        const categoryName = "<?php echo e($category->name); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/software-setup/asset-category/fields.blade.php ENDPATH**/ ?>