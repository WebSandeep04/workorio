<?php $__env->startSection('title', 'Calling Analytics'); ?>
<?php $__env->startSection('page_title', 'Calling Analytics Dashboard'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex gap-3">
                <a href="<?php echo e(route('calling.mycalling')); ?>" class="btn btn-primary px-4 py-2" style="border-radius: 8px; font-weight: 600; font-family: Montserrat;">
                    <i class="bi bi-telephone me-2"></i> Start Calling Now
                </a>
                <a href="<?php echo e(route('calling.index')); ?>" class="btn btn-outline-secondary px-4 py-2" style="border-radius: 8px; font-weight: 600; font-family: Montserrat;">
...
function loadAnalyticsData() {
    $.get('<?php echo e(route("calling.analytics.data")); ?>', function(resp) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/calling/analytics.blade.php ENDPATH**/ ?>