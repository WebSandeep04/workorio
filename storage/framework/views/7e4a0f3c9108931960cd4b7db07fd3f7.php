...
<script>
    $(document).ready(function() {
        ...
        $('#resetFilters').on('click', function() {
            ...
            $.post('<?php echo e(route("calling.selection.clear")); ?>', () => applyFilters(1));
        });
        ...
        $('#lockLeadsBtn').on('click', function() {
            ...
            $.post('<?php echo e(route("calling.lock-leads")); ?>', { campaign_id: campaignId, use_session_selection: true })
            .done(resp => {
                if (resp.success) {
