    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        if(response.data.length > 0) {
          ...
          rows = `<tr><td colspan="6" class="text-center py-4 text-muted">No data found</td></tr>`;
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Don't Delete\laravel\leadmanagement (akrati ui work)\resources\views/pettycash/index.blade.php ENDPATH**/ ?>