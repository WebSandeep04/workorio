...
<div class="container-fluid">
    ...
    <div class="table-search">
        ...
        <a href="<?php echo e(route('quotation.create')); ?>" class="table-search-btn">
...
function loadCustomers() {
    $.get("<?php echo e(route('quotation.customers')); ?>")
        .done(function(resp) {
...
function loadProspects() {
    $.get("<?php echo e(route('quotation.prospects')); ?>")
        .done(function(resp) {
...
function reviseQuote(no) {
    window.location.href = `<?php echo e(route('quotation.create')); ?>?quote=${encodeURIComponent(no)}&revise=1`;
}
...
function openRevisionHistory(id, no) {
    ...
    $.get(`<?php echo e(url('/quotation')); ?>/${id}/revisions`)
        .done(function(resp) {
