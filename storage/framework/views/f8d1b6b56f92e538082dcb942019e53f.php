...
<?php $__env->startSection('title', 'Sales Status'); ?>
<?php $__env->startSection('page_title', 'Sales Status'); ?>
...
<div class="container-fluid px-2">
  <div class="table-search mb-2">
    <div class="table-search-field">
      ...
      <input type="text" id="search" placeholder="Search status..." />
    </div>
  ...
  <div class="modern-card data-table-card">
    <div class="modern-card-body">
      <div class="table-responsive">
        <table class="table custom-table" id="salesStatusTable">
          <thead>
            <tr>
              <th>Status Name</th>
              <th>Actions</th>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="createStatusModalLabel">
      ...
      <form id="createStatusForm">
        <div class="modal-body pt-4 pb-4">
          ...
          <div class="mb-2">
            ...
            <input type="text" class="form-control form-control-modern" id="status_name" name="status_name" required placeholder="Enter status name">
          </div>
        </div>
...
<div class="modal fade modal-modern" id="editStatusModal" tabindex="-1" aria-labelledby="editStatusModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="editStatusModalLabel">
...
$(function () {
  ...
  function loadStatus(page = 1) {
    ...
    $.get(`<?php echo e(route('status.fetch')); ?>?page=${page}&search=${search}`, function (data) {
      ...
      $.each(data.data, function (i, s) {
        rows += `
          <tr style="animation-delay: ${i * 0.1}s;">
            <td><strong>${s.status_name}</strong></td>
            <td>
              <div class="d-flex gap-2 justify-content-center">
                <button class="btn-action btn-action-edit editBtn" data-id="${s.id}" data-name="${s.status_name}" title="Edit">
      ...
      $('#salesStatusTable tbody').html(`
        <tr>
          <td colspan="2" class="text-danger text-center py-4">
            ...
            <p class="mt-2 mb-0">Failed to load statuses. Please try again.</p>
          </td>
        </tr>
      `);
    });
  ...
  $('#createStatusForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('status.store')); ?>", {
      ...
      showAlert('error', 'Failed to create status.');
    }).always(function() {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\leadmanagement (akrati ui work)\resources\views/status.blade.php ENDPATH**/ ?>