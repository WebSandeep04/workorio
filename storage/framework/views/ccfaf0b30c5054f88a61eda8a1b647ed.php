        ...
        columns: [
            ...
            }},
            {
                ...
                render: function(data, type, row) {
                    return `<button class="btn btn-sm btn-info text-white view-history-btn shift-btn" data-id="${data}" data-name="${row.name}" title="View Shift History"><i class="fas fa-history"></i> History</button>`;
                }
            }
        ],
        select: {
