...
(function () {
  ...
  function deleteBranch(id){
    ...
    $.ajax({
      url: `<?php echo e(url('/branches')); ?>/${id}`,
      method: 'DELETE',
      data: { _token: csrf },
    })
    .done(function(){
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dont Delete\laravel\leadmanagement (akrati ui work)\resources\views/master/branches.blade.php ENDPATH**/ ?>