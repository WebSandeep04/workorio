    ...
    <div class="data-table-card">
        <div class="table-scroll">
            <table class="table custom-table" id="callingTable">
                ...
                <tbody>
                    <tr><td colspan="10" class="text-center p-4 text-muted">Awaiting data stream...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        function loadFilterData() {
            $.get('<?php echo e(route("calling.converted.filter-options")); ?>', function(resp) {
        ...
        function loadCitiesByState(stateId) {
            ...
            $.get('<?php echo e(route("calling.converted.cities", ["stateId" => ":id"])); ?>'.replace(':id', stateId), function(cities){
            ...
            if (rows && rows.length) {
                rows.forEach(function(r){
                    ...
                    html += `<tr>
                        ...
                        <td class="text-success fw-semibold">${r.assigned_to_name || '-'}</td>
                ...
                html = '<tr><td colspan="10" class="text-center p-5 text-muted">Empty assignment list.</td></tr>';
            }
            $tbody.html(html);
        }
        ...
        function loadData(page = 1) {
            ...
            $.post('<?php echo e(route("calling.converted.filter")); ?>?page=' + page, {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/calling/converted.blade.php ENDPATH**/ ?>