    ...
    <div class="col-md-12 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-success" onclick="openSendModal(<?php echo e($whatsapp_campaign->id); ?>)">
...
<script>
    ...
    function fetchSourceData(page = 1) {
        ...
        fetch(`<?php echo e(route('whatsapp-campaigns.source-data')); ?>?source_type=${sourceType}&search=${encodeURIComponent(search)}&page=${page}`)
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\workorio\resources\views/whatsapp_campaigns/show.blade.php ENDPATH**/ ?>