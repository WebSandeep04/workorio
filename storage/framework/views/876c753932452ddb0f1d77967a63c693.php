...
<?php $__env->startSection('title', 'All Data - Under Process'); ?>
<?php $__env->startSection('page_title', 'All Data - Under Process'); ?>
  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon icon-amber">
        <img src="<?php echo e(asset('img/icons/underprocess.png')); ?>" alt="Under Process" onerror="this.onerror=null;this.src='<?php echo e(asset('img/icons/underprocess.png')); ?>';">
      </div>
...
function loadData(page = 1) {
  $.ajax({
    url: `<?php echo e(route('alldata.under-process.data')); ?>?page=${page}`,
    method: 'GET',
    success: function (response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Don't Delete\laravel\leadmanagement (akrati ui work)\resources\views/alldata/under-process.blade.php ENDPATH**/ ?>