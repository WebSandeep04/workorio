...
<div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
    <div style="background-color: <?php echo e($status === 'approved' ? '#10b981' : '#ef4444'); ?>; padding: 25px; color: white; text-align: center;">
        <h2 style="margin: 0; font-size: 24px;">Leave Request <?php echo e(ucfirst($status)); ?></h2>
    ...
    <div style="padding: 25px; color: #374151;">
        <p style="margin-top: 0; font-size: 16px;">Hello <strong><?php echo e($user->name); ?></strong>,</p>
        <p style="font-size: 14px; line-height: 1.5;">
            Your leave request has been <strong><?php echo e($status); ?></strong>. Below are the details of your application:
        </p>
        ...
        <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 6px; padding: 15px; margin-top: 20px;">
            <table width="100%" cellspacing="0" cellpadding="0" style="font-size: 14px; border-collapse: collapse;">
                ...
                <?php endif; ?>
                <?php if($status === 'rejected' && $leaveRequest->reject_reason): ?>
                <tr style="border-top: 1px solid #e5e7eb;">
                    <td style="padding: 8px 0; color: #ef4444;"><strong>Rejection Reason</strong></td>
                    <td style="padding: 8px 0; color: #ef4444; font-weight: bold; white-space: pre-wrap;"><?php echo e($leaveRequest->reject_reason); ?></td>
                </tr>
                <?php endif; ?>
            </table>
        </div>
...
<?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/emails/leave_status.blade.php ENDPATH**/ ?>