        ...
        <div class="hcards">
            ...
            <div class="card" style="border: 1px solid #e5e7eb; border-radius: 16px; padding: 20px;">
                <div class="chead" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                    ...
                    <span class="va" onclick="location.href='<?php echo e(($currentUser && $currentUser->role_id == 1 || $currentUser->role_id == 3 ) ? route('attendance.report') : route('attendance.history')); ?>'" style="color: #2563eb; font-size: 12px; font-weight: 500; cursor: pointer; text-decoration: none;">View all</span>
                </div>
        ...
        <div class="hcards">
            ...
            <div class="card">
                <div class="chead">
                    ...
                    <!-- <span class="va" onclick="location.href='<?php echo e(route('holidays.index')); ?>'">View all</span> -->
                </div>
...
function viewAllApprovals() {
    ...
    let targetRoute = '#';
    if (id === 'ap-ts') targetRoute = '<?php echo e(route("worklog-approvals")); ?>';
    else if (id === 'ap-at') targetRoute = '<?php echo e(route("attendance.approval")); ?>';
    else if (id === 'ap-tk') targetRoute = '<?php echo e(route("all-tasks.index")); ?>';
    else if (id === 'ap-lv') targetRoute = '<?php echo e(route("leave.approvals")); ?>';
    else if (id === 'ap-pc') targetRoute = '<?php echo e(route("approvals.petty")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\workorio\resources\views/dashboard.blade.php ENDPATH**/ ?>