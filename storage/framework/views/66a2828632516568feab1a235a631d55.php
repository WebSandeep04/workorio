        ...
        <div class="hcards">
            ...
            <div class="card" style="border: 1px solid #e5e7eb; border-radius: 16px; padding: 20px;">
                <div class="chead" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                    ...
                    <span class="va" onclick="location.href='<?php echo e(($currentUser && $currentUser->role_id == 1) ? route('attendance.report') : route('attendance.history')); ?>'" style="color: #2563eb; font-size: 12px; font-weight: 500; cursor: pointer; text-decoration: none;">View all</span>
                </div>
