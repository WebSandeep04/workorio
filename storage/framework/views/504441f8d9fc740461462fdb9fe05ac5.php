...
<?php $__env->startSection('title', 'Sales Business'); ?>
<?php $__env->startSection('page_title', 'Sales Business'); ?>
...
<div class="container-fluid px-2">
  <div class="table-search mb-2">
    <div class="table-search-field">
      ...
      <input type="text" id="search" placeholder="Search business type..." />
    </div>
    <button class="table-search-btn" data-bs-toggle="modal" data-bs-target="#createBusinessModal">
      <i class="bi bi-plus me-1"></i>Create Business Type
    </button>
  </div>
  ...
  <div class="modern-card data-table-card">
    <div class="modern-card-body">
      <div class="table-responsive">
        <table class="table custom-table" id="salesBusinessTable">
          <thead>
            <tr>
              <th>Business Name</th>
              <th>Actions</th>
          ...
          <tbody>
            <tr>
              <td colspan="2" class="loading-state">
                ...
                <p class="mt-2 mb-0">Loading business types...</p>
              </td>
            </tr>
          </tbody>
        </table>
  ...
  <div class="table-range-meta" id="businessRangeInfo">
...
<div class="modal fade modal-modern" id="createBusinessModal" tabindex="-1" aria-labelledby="createBusinessModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="createBusinessModalLabel">
      ...
      <form id="createBusinessForm">
        <div class="modal-body pt-4 pb-4">
          <?php echo csrf_field(); ?>
          <div class="mb-2">
            <label for="business_name" class="form-label-modern">Business Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="business_name" name="business_name" required placeholder="Enter business name">
          </div>
        </div>
...
<!-- Edit Business Modal -->
<div class="modal fade modal-modern" id="editBusinessModal" tabindex="-1" aria-labelledby="editBusinessModalLabel" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" style ="font-size: 1.1rem; font-weight: 600;" id="editBusinessModalLabel">
      ...
      <form id="editBusinessForm">
        <div class="modal-body pt-4 pb-4">
          ...
          <div class="mb-2">
            <label for="edit_business_name" class="form-label-modern">Business Name <span class="text-danger">*</span></label>
            <input type="text" class="form-control form-control-modern" id="edit_business_name" required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn-modern btn-modern-primary w-100 justify-content-center" style="background: #434AFA; color: white;">
...
$(function () {
  ...
  function loadBusiness(page = 1) {
    ...
    $.get(`<?php echo e(route('business.fetch')); ?>?page=${page}&search=${search}`, function (data) {
      if (!data.data || data.data.length === 0) {
        $('#salesBusinessTable tbody').html(`
          <tr>
            <td colspan="2" class="empty-state">
              <i class="bi bi-inbox"></i>
              <h5>No Business Types Found</h5>
              <p>Get started by creating your first business type.</p>
            </td>
          </tr>
        `);
          ...
          <tr style="animation-delay: ${i * 0.1}s;">
            ...
            <td>
              <div class="d-flex gap-2 justify-content-center">
                <button class="btn-action btn-action-edit editBtn" data-id="${s.id}" data-name="${s.business_name}" title="Edit">
      ...
      $('#salesBusinessTable tbody').html(`
        <tr>
          <td colspan="2" class="text-danger text-center py-4">
            ...
            <p class="mt-2 mb-0">Failed to load business types. Please try again.</p>
          </td>
        </tr>
      `);
    });
  ...
  $('#createBusinessForm').submit(function (e) {
    ...
    $.post("<?php echo e(route('business.store')); ?>", {
      ...
      loadBusiness();
      showAlert('success', 'Business type created successfully.');
    }).fail(function (xhr) {
      showAlert('error', 'Failed to create business type.');
    }).always(function() {
  ...
  $('#editBusinessForm').submit(function (e) {
    ...
    $.ajax({
      ...
      error: function() {
        showAlert('error', 'Failed to update business type.');
      },
      always: function() {
  ...
  $(document).on('click', '.deleteBtn', function () {
    if (confirm('Are you sure you want to delete this business type?')) {
      $.ajax({
        ...
        success: function () {
          loadBusiness();
          showAlert('success', 'Business type deleted successfully.');
        },
        error: function() {
          showAlert('error', 'Failed to delete business type.');
        }
      });
    }
  });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DontDelete\laravel\leadmanagement (akrati ui work)\resources\views/business.blade.php ENDPATH**/ ?>