        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.data.length > 0) {
                    ...
                    html = '<tr><td colspan="4" class="text-center py-4 text-muted">No leave types found. Please run the migration first if this is a fresh database.</td></tr>';
                    $('#paginationContainer').html('');
                }
                $('#tableBody').html(html);
            },
            error: function() {
                $('#tableBody').html('<tr><td colspan="4" class="text-center text-danger">Error loading data. Try again.</td></tr>');
            }
        });
    }
