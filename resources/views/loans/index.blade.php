        ...
        <div class="modal-body bg-white pt-4 pb-4">
          ...
          <div class="row g-3 mb-3">
              <div class="col-md-6">
                  ...
                  <input type="number" step="0.01" name="emi_amount" class="form-control-modern" required value="{{ old('emi_amount') }}">
              </div>
              <div class="col-md-6">
                  <label class="form-label-modern">Start Month <span class="text-danger">*</span></label>
                  <input type="month" name="start_month" class="form-control-modern" required value="{{ old('start_month') }}" min="{{ \Carbon\Carbon::now()->addMonth()->format('Y-m') }}">
              </div>
          </div>
