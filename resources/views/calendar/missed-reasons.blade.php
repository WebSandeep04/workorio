...
@section('title', 'Missed Reasons')
@section('page_title', 'Missed Reasons')
...
$(function () {
  ...
  function loadReasons(page = 1) {
    ...
    $.get(`{{ route('calendar-missed-reasons.fetch') }}?page=${page}&search=${search}`)
      .done(function (data) {
  ...
  $('#createReasonForm').on('submit', function (e) {
    ...
    $.post("{{ route('calendar-missed-reasons.store') }}", {
