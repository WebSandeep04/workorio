...
@section('title', 'Calendar Clients')
@section('page_title', 'Calendar Clients')
...
(function(){
  ...
  function loadClients(page = 1) {
    ...
    $.get(`{{ route('calendar-clients.fetch') }}?page=${page}&search=${search}`)
      .done(function (data) {
  ...
  $('#createClientForm').on('submit', function (e) {
    ...
    $.post("{{ route('calendar-clients.store') }}", payload)
