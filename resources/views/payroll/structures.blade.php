            ...
            <div class="col-12 mt-4">
              ...
              <div class="components-list" style="max-height: 350px; overflow-y: auto; padding-right: 5px;">
                @forelse($components as $component)
                  <div class="component-item" data-id="{{ $component->id }}" data-calc-type="{{ $component->calculation_type }}">
                    <div class="component-header">
                      <div class="form-check">
                        <input class="form-check-input component-checkbox" type="checkbox" id="comp_{{ $component->id }}" value="{{ $component->id }}">
                        <label class="form-check-label fw-bold ms-1" for="comp_{{ $component->id }}">
                          {{ $component->name }} 
                          <span class="badge badge-modern-info ms-2" style="font-size: 0.65rem;">{{ strtoupper($component->type) }}</span>
                          <span class="badge badge-modern-secondary" style="font-size: 0.65rem;">{{ strtoupper($component->calculation_type) }}</span>
                        </label>
                      </div>
                    </div>
                    <div class="component-config mt-2 ps-4">
                      @if($component->calculation_type === 'fixed' || $component->calculation_type === 'percentage')
                        <div class="input-group input-group-sm w-50">
                          <span class="input-group-text">{{ $component->calculation_type === 'percentage' ? '%' : '₹' }}</span>
...
$(function () {
  ...
  const baseUrl = "{{ route('payroll.structures.index') }}";
  let searchTimeout;
