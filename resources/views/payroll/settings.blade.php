        ...
        <div class="modern-card">
          ...
          <div class="modern-card-body">
            <div class="mb-3">
              ...
              <input type="number" name="salary_cycle_start" id="salary_cycle_start" class="form-control form-control-modern" min="1" max="31" value="{{ $settings->salary_cycle_start ?? 1 }}" required>
            ...
            <div class="mb-3">
              ...
              <input type="number" name="salary_cycle_end" id="salary_cycle_end" class="form-control form-control-modern" min="1" max="31" value="{{ $settings->salary_cycle_end ?? 31 }}" required>
          ...
          <div class="modern-card-body p-0 px-3">
            ...
            <div class="setting-row">
              ...
              <label class="toggle-switch">
                <input type="checkbox" name="attendance_based" id="attendance_based" value="1" {{ ($settings->attendance_based ?? true) ? 'checked' : '' }}>
            ...
            <div class="setting-row">
              ...
              <label class="toggle-switch">
                <input type="checkbox" name="pf_enabled" id="pf_enabled" value="1" {{ ($settings->pf_enabled ?? false) ? 'checked' : '' }}>
                <span class="slider"></span>
              </label>
            </div>
            ...
            <div class="setting-row">
              ...
              <label class="toggle-switch">
                <input type="checkbox" name="esi_enabled" id="esi_enabled" value="1" {{ ($settings->esi_enabled ?? false) ? 'checked' : '' }}>
                <span class="slider"></span>
              </label>
            </div>
            ...
            <div class="setting-row">
              ...
              <label class="toggle-switch">
                <input type="checkbox" name="pt_enabled" id="pt_enabled" value="1" {{ ($settings->pt_enabled ?? false) ? 'checked' : '' }}>
                <span class="slider"></span>
              </label>
            </div>
            ...
            <div class="setting-row">
              ...
              <label class="toggle-switch">
                <input type="checkbox" name="tds_enabled" id="tds_enabled" value="1" {{ ($settings->tds_enabled ?? false) ? 'checked' : '' }}>
                <span class="slider"></span>
              </label>
            </div>
