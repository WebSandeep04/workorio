...
<div class="mobile-header-bar d-md-none">
    ...
    <div class="mobile-header-logo">
        <img src="{{ asset('img/logoformenu.svg') }}" alt="Workorio Logo">
    </div>
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <form method="POST" action="{{ route($isSuperAdmin ? 'superadmin.logout' : 'logout') }}" class="m-0">
            @csrf
...
<div class="mobile-sidebar" id="mobileSidebar">
    ...
    <div class="mobile-sidebar-content">
        ...
        @if($isSuperAdmin)
        <a href="{{route('tenant')}}" class="mobile-menu-item" title="Tenant Management">
