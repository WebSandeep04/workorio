...
@section('page_title', 'Opening Balance')
...
$(function () {
  ...
  function loadData(page = 1) {
    ...
    $.get(`{{ route('petty-opening-balance.fetch') }}?page=${page}&search=${search}`, function (data) {
  ...
  $('#createBalanceForm').submit(function (e) {
    ...
    $.post("{{ route('petty-opening-balance.store') }}", $(this).serialize(), function () {
