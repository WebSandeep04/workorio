...
@section('title', 'Subscription Customers')
@section('page_title', 'Subscription Customers')
  ...
  <div class="summary-cards">
    ...
    <div class="summary-card card-2">
      ...
      <div class="summary-card-content">
        ...
        <div class="summary-card-value">{{ $totalSubscriptions }}</div>
      </div>
    </div>
    <div class="summary-card card-3">
      ...
      <div class="summary-card-content">
        ...
        <div class="summary-card-value">{{ $comingDueCount }}</div>
      </div>
    </div>
...
$(document).ready(function() {
    ...
    function loadSubscriptions(page, params) {
        ...
        let url = '{{ route("subscriptions.filter") }}'; 
    ...
    $.ajax({
        url: '{{ route("subscriptions.customers") }}',
        type: 'GET',
        success: function(data) {
