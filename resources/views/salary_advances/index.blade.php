...
@section('title', 'My Salary Advances')
@section('page_title', 'My Salary Advances')
...
<div class="modal fade" id="formModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ route('salary_advances.store') }}" method="POST" id="mainForm">
        <div class="modal-body bg-white pt-4 pb-4">
          ...
          <div class="row g-3 mb-3">
              ...
              <div class="col-md-6">
                  ...
                  <input type="month" name="deduction_start_month" class="form-control-modern" required value="{{ old('deduction_start_month') }}" min="{{ \Carbon\Carbon::now()->addMonth()->format('Y-m') }}">
              </div>
          </div>
...
<script>
    ...
    let defaultAction = "{{ route('salary_advances.store') }}";
    let allAdvances = [];

    function fetchAdvances() {
        $.ajax({
            url: "{{ route('salary_advances.fetch') }}",
            type: "POST",
