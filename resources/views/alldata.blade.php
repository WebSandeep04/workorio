  ...
  <div class="container-fluid px-2">
    ...
    <div class="summary-cards">
      <div class="summary-card card-1">
        ...
        <a href="{{ route('alldata.today-followups') }}" class="metric-arrow"><i class="bi bi-arrow-right"></i></a>
      </div>
      <div class="summary-card card-2">
        ...
        <a href="{{ route('alldata.under-process') }}" class="metric-arrow"><i class="bi bi-arrow-right"></i></a>
      </div>
      <div class="summary-card card-3">
        ...
        <a href="{{ route('alldata.today-completed') }}" class="metric-arrow"><i class="bi bi-arrow-right"></i></a>
      </div>
      <div class="summary-card card-4">
        ...
        <a href="{{ route('alldata.today-pending') }}" class="metric-arrow"><i class="bi bi-arrow-right"></i></a>
      </div>
      <div class="summary-card card-5">
        ...
        <a href="{{ route('alldata.today-new') }}" class="metric-arrow"><i class="bi bi-arrow-right"></i></a>
      </div>
    </div>
    ...
    <x-filter-panel :show-search="false" />
...
@push('scripts')
  <script>
    ...
    function loadSummaryStats() {
      $.get("{{ route('alldata.summary-stats') }}")
        .done(function (data) {
    ...
    function loadStatusCounts() {
      $.get("{{ route('alldata.status-counts') }}")
        .done(function (data) {
    ...
    function loadTeamMembers() {
      var teamMembersUrl = '{{ route("alldata.team-members") }}';
