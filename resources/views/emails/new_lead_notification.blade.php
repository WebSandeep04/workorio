    ...
    <div style="background-color: #4f46e5; padding:20px; color:white;">
        <table width="100%">
            <tr>
                ...
                <td style="text-align:right;font-size:12px;opacity:0.9;">{{ \Carbon\Carbon::now()->format('d M Y') }}</td>
            </tr>
        </table>
    </div>
        ...
        <div style="border:1px solid #e5e7eb; overflow:hidden;">
            <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                <tr style="background:#f9fafb;border-bottom:1px solid #e5e7eb;">
                    ...
                    <td style="padding:6px 8px;font-size:11px;color:#111827;">{{ $lead->leads_name ?? 'N/A' }}</td>
                </tr>
                <tr style="background:#ffffff;border-bottom:1px solid #e5e7eb;">
                    ...
                    <td style="padding:6px 8px;font-size:11px;color:#111827;">{{ $lead->contact_person ?? 'N/A' }}</td>
                </tr>
                <tr style="background:#f9fafb;border-bottom:1px solid #e5e7eb;">
                    <td style="padding:6px 8px;font-size:11px;color:#6b7280;font-weight:700;">Contact Number</td>
                    <td style="padding:6px 8px;font-size:11px;color:#111827;">{{ $lead->contact_number ?? 'N/A' }}</td>
                </tr>
                <tr style="background:#ffffff;border-bottom:1px solid #e5e7eb;">
                    <td style="padding:6px 8px;font-size:11px;color:#6b7280;font-weight:700;">Email</td>
                    <td style="padding:6px 8px;font-size:11px;color:#111827;">{{ $lead->email ?? 'N/A' }}</td>
                </tr>
                <tr style="background:#f9fafb;border-bottom:1px solid #e5e7eb;">
                    <td style="padding:6px 8px;font-size:11px;color:#6b7280;font-weight:700;">Next Follow-up</td>
                    <td style="padding:6px 8px;font-size:11px;color:#dc2626;font-weight:700;">{{ $lead->next_follow_up_date ? \Carbon\Carbon::parse($lead->next_follow_up_date)->format('d M Y') : 'N/A' }}</td>
                </tr>
                <tr style="background:#ffffff;border-bottom:1px solid #e5e7eb;">
                    <td style="padding:6px 8px;font-size:11px;color:#6b7280;font-weight:700;">Address</td>
                    <td style="padding:6px 8px;font-size:11px;color:#111827;white-space:normal;">{{ $lead->address ?? 'N/A' }}</td>
                </tr>
                <tr style="background:#f9fafb;border-bottom:1px solid #e5e7eb;">
                    <td style="padding:6px 8px;font-size:11px;color:#6b7280;font-weight:700;">Website</td>
                    <td style="padding:6px 8px;font-size:11px;color:#2563eb;">{{ $lead->website_link ?? 'N/A' }}</td>
                </tr>
                <tr style="background:#ffffff;border-bottom:1px solid #e5e7eb;">
