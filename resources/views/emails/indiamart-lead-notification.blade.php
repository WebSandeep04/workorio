    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="field">
                ...
                <span class="value">{{ $leadData['sender_name'] ?? 'N/A' }}</span>
            </div>
            
            <div class="field">
                <span class="label">Company:</span>
                <span class="value">{{ $leadData['sender_company'] ?? 'N/A' }}</span>
            </div>
            
            <div class="field">
                <span class="label">Mobile:</span>
                <span class="value">{{ $leadData['sender_mobile'] ?? 'N/A' }}</span>
            </div>
            
            <div class="field">
                <span class="label">Email:</span>
                <span class="value">{{ $leadData['sender_email'] ?? 'N/A' }}</span>
            </div>
            
            <div class="field">
                <span class="label">City:</span>
                <span class="value">{{ $leadData['sender_city'] ?? 'N/A' }}</span>
            </div>
            
            <div class="field">
                <span class="label">State:</span>
                <span class="value">{{ $leadData['sender_state'] ?? 'N/A' }}</span>
            </div>
            
            <div class="field">
                <span class="label">Product Interest:</span>
                <span class="value">{{ $leadData['query_product_name'] ?? 'N/A' }}</span>
            </div>
            
            <div class="field">
                <span class="label">Query Type:</span>
                <span class="value">{{ $leadData['query_type'] ?? 'N/A' }}</span>
            </div>
