        ...
        <div class="quotation-card">
            ...
            <table class="formal-quote-table">
                ...
                <tfoot>
                    ...
                    <tr><td colspan="4" class="text-right">Tax(GST 18%):</td><td class="text-right">{{ number_format($tax_sum, 2) }}</td></tr>
                    @if(($quote->data['discount'] ?? 0) > 0)
                        <tr><td colspan="4" class="text-right">Discount:</td><td class="text-right">-{{ number_format($quote->data['discount'], 2) }}</td></tr>
                    @endif
                    <tr style="font-size: 13px; color: #0088CC; font-weight: bold;"><td colspan="4" class="text-right" style="border-top: 2px solid #0088CC;">GRAND TOTAL:</td><td class="text-right" style="border-top: 2px solid #0088CC;">{{ number_format($quote->total_amount, 2) }}</td></tr>
                </tfoot>
            </table>
