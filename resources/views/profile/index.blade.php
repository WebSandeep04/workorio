          ...
          <form id="profileForm">
            ...
            <div class="row mb-4">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control-modern" name="name" value="{{ $employee->name }}" required>
              </div>
              <div class="col-md-4 mb-3">
                <label class="form-label-modern">Work Email <span class="text-danger">*</span></label>
                <input type="email" class="form-control-modern" name="email" value="{{ $employee->email }}" required>
              </div>
              <div class="col-md-4 mb-3">
                <label class="form-label-modern">Employee Code</label>
                <input type="text" class="form-control-modern" value="{{ $employee->employee_code }}" readonly style="background-color: #f3f4f6;">
              </div>
              <div class="col-md-4 mb-3">
                  <label class="form-label-modern">Phone Number</label>
                  <input type="text" class="form-control-modern" name="phone" value="{{ $employee->phone }}">
              </div>
              <div class="col-md-4 mb-3">
                  <label class="form-label-modern">Designation</label>
                  <input type="text" class="form-control-modern" name="designation" value="{{ $employee->designation }}">
              </div>
              <div class="col-md-4 mb-3">
            ...
            <div class="row mb-4">
                 <div class="col-md-4 mb-3">
                    ...
                    <input type="email" class="form-control-modern" name="personal_email" value="{{ $employee->personal_email }}">
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control-modern" name="blood_group" value="{{ $employee->blood_group }}" placeholder="e.g. O+">
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control-modern" name="spouse_name" value="{{ $employee->spouse_name }}">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label-modern">Number of Dependents</label>
                    <input type="number" class="form-control-modern" name="number_of_dependents" value="{{ $employee->number_of_dependents }}">
                </div>
            </div>
            ...
            <div class="row mb-4">
                 <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control-modern" name="aadhaar_number" value="{{ $employee->aadhaar_number }}">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control-modern" name="pan_number" value="{{ $employee->pan_number }}">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control-modern" name="passport_number" value="{{ $employee->passport_number }}">
                </div>
                 <div class="col-md-3 mb-3">
            ...
            <div class="row mb-4">
                <div class="col-md-4 mb-3">
                    <label class="form-label-modern">Highest Qualification</label>
                     <input type="text" class="form-control-modern" name="highest_qualification" value="{{ $employee->highest_qualification }}">
                </div>
                <div class="col-md-4 mb-3">
                     <label class="form-label-modern">Institution Name</label>
                     <input type="text" class="form-control-modern" name="institution_name" value="{{ $employee->institution_name }}">
                </div>
                 <div class="col-md-4 mb-3">
                     <label class="form-label-modern">Previous Employer</label>
                     <input type="text" class="form-control-modern" name="previous_employer" value="{{ $employee->previous_employer }}">
                </div>
                <div class="col-md-4 mb-3">
                     <label class="form-label-modern">Total Experience (Years)</label>
                     <input type="number" step="0.1" class="form-control-modern" name="experience_years" value="{{ $employee->experience_years }}">
                </div>
            ...
            <div class="row mb-4">
                 <div class="col-md-4 mb-3">
                    <label class="form-label-modern">Bank Name</label>
                     <input type="text" class="form-control-modern" name="bank_name" value="{{ $employee->bank_name }}">
                </div>
                 <div class="col-md-4 mb-3">
                    <label class="form-label-modern">Account Number</label>
                     <input type="text" class="form-control-modern" name="bank_account_number" value="{{ $employee->bank_account_number }}">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label-modern">IFSC Code</label>
                     <input type="text" class="form-control-modern" name="ifsc_code" value="{{ $employee->ifsc_code }}">
                </div>
                 <div class="col-md-4 mb-3">
            ...
            <div class="row mb-4">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control-modern" name="address_line" value="{{ $employee->address_line }}">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label-modern">City</label>
                    <input type="text" class="form-control-modern" name="city" value="{{ $employee->city }}">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label-modern">State</label>
                    <input type="text" class="form-control-modern" name="state" value="{{ $employee->state }}">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label-modern">Country</label>
                    <input type="text" class="form-control-modern" name="country" value="{{ $employee->country }}">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label-modern">Postal Code</label>
                    <input type="text" class="form-control-modern" name="postal_code" value="{{ $employee->postal_code }}">
                </div>
            </div>
            ...
            <h6 class="text-uppercase text-muted mb-3" style="font-size: 0.75rem; letter-spacing: 1px; font-weight: 700;">Emergency Contact</h6>
             <div class="row mb-4">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control-modern" name="emergency_contact_name" value="{{ $employee->emergency_contact_name }}">
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label-modern">Contact Phone</label>
                    <input type="text" class="form-control-modern" name="emergency_contact_phone" value="{{ $employee->emergency_contact_phone }}">
                </div>
                 <div class="col-md-4 mb-3">
                    <label class="form-label-modern">Relation</label>
                    <input type="text" class="form-control-modern" name="emergency_contact_relation" value="{{ $employee->emergency_contact_relation }}">
                </div>
            </div>
...
<script>
    ...
    let existingDocuments = @json($employee->documents ?? []);
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete-document', function() {
            ...
            $.ajax({
                url: "{{ route('profile.documents.destroy', 'DOC_ID') }}".replace('DOC_ID', docId),
                method: "DELETE",
                data: { _token: csrf },
        ...
        function uploadDocuments(callback) {
            ...
            documents.forEach(function(doc) {
                ...
                $.ajax({
                    url: "{{ route('profile.documents.store') }}",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
