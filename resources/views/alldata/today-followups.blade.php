...
@section('title', 'All Data - Today\'s Follow Ups')
@section('page_title', 'All Data - Today\'s Follow Ups')
  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon icon-sunrise">
        <img src="{{ asset('img/icons/call.png') }}" alt="Followups" onerror="this.onerror=null;this.src='{{ asset('img/icons/call.png') }}';">
      </div>
...
function loadFollowups(page = 1) {
  $.ajax({
    url: `{{ route('alldata.today-followups.data') }}?page=${page}`,
    method: 'GET',
    success: function (response) {
