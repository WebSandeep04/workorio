...
@section('title', 'All Data - Today Pending')
@section('page_title', 'All Data - Today Pending')
@push('styles')
<style>
  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon icon-rose">
        <img src="{{ asset('img/icons/pending.png') }}" alt="Pending" onerror="this.onerror=null;this.src='{{ asset('img/icons/clock.png') }}';">
      </div>
...
function loadData(page = 1) {
  $.ajax({
    url: `{{ route('alldata.today-pending.data') }}?page=${page}`,
    method: 'GET',
    success: function (response) {
