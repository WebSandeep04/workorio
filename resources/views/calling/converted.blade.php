...
<script>
    $(document).ready(function() {
        ...
        function loadFilterData() {
            $.get('{{ route("calling.converted.filter-options") }}', function(resp) {
        ...
        function loadCitiesByState(stateId) {
            ...
            $.get('{{ route("calling.converted.cities", ["stateId" => ":id"]) }}'.replace(':id', stateId), function(cities){
        ...
        function loadData(page = 1) {
            ...
            $.post('{{ route("calling.converted.filter") }}?page=' + page, {
