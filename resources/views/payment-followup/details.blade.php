...
@section('title', 'Payment Followup Details')
@section('page_title', 'Payment Followup Details')
...
<div class="container-fluid px-2">
  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon {{ $iconClass }}">
        <img src="{{ asset('img/icons/' . $iconImg) }}" alt="{{ $cardTitle }}" onerror="this.onerror=null;this.src='{{ asset('img/icons/file.png') }}';">
      </div>
      <div class="summary-card-content">
        <div class="summary-card-label">{{ $cardTitle }}</div>
...
<script>
    ...
    function loadData(page = 1) {
        ...
        $.ajax({
            url: '{{ route("payment-followup.details.data", ["type" => ":type"]) }}'.replace(':type', type),
            type: 'GET',
            data: data,
