...
@section('title', 'Today Completed')
@section('page_title', 'Today Completed')
@push('styles')
<style>
  ...
  <div class="summary-cards mb-3">
    <div class="summary-card card-1" style="max-width: 250px;">
      <div class="summary-card-icon icon-emerald">
        <img src="{{ asset('img/icons/completed.png') }}" alt="Completed" onerror="this.onerror=null;this.src='{{ asset('img/icons/call.png') }}';">
      </div>
